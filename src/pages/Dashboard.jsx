  ...
  return (
    <div className="fade-in">
      ...
      <div style={{ display:'grid', gridTemplateColumns:'repeat(auto-fit, minmax(280px, 1fr))', gap:'var(--space-lg)', marginBottom:'var(--space-xl)' }}>
        <KPICard
          label="kW Gerado / ton Vapor Produzido"
          numerador={kpis.dKwhGer}
          denominador={kpis.dVapor}
          result={kpis.kwhPorVapor}
          unit="kW / ton·Vapor"
          numLabel="Energia Gerada (kW)"
          denLabel="Vazão Vapor (ton)"
        />
        <KPICard
          label="kWh Consumido / ton Vapor Produzido"
          numerador={kpis.dKwhCon}
          denominador={kpis.dVapor}
          result={kpis.kwhConsPorVap}
          unit="kWh / ton·Vapor"
          numLabel="Energia Consumida (kWh)"
          denLabel="Vazão Vapor (ton)"
        />
        <KPICard
          label="kg Vapor Produzido / m³ Cavaco Consumido"
          numerador={kpis.dVaporKg}
          denominador={kpis.dCavaco}
          result={kpis.vaporPorCavaco}
          unit="kg·Vapor / m³·Cavaco"
          numLabel="Vazão Vapor (kg)"
          denLabel="Consumo Cavaco (m³)"
        />
      </div>
